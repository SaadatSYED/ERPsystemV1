...
var dtwt = (theme11 = {}, tokenPath, fallback, type) => {
  if (tokenPath) {
    ...
    const {
      prefix,
      transform
    } = (theme11 == null ? void 0 : theme11.options) || OPTIONS || {};
    const regex = /{([^}]*)}/g;
...
var themeUtils_default = {
  ...
  _toVariables(theme11, options) {
    return toVariables_default(theme11, {
...
var SelectItem = class _SelectItem extends BaseComponent {
  ...
  static ɵcmp = ɵɵdefineComponent({
    ...
    template: function SelectItem_Template(rf, ctx) {
      ...
      if (rf & 2) {
        ɵɵproperty("id", ctx.id)("ngStyle", ɵɵpureFunction1(14, _c07, ctx.itemSize + "px"))("ngClass", ɵɵpureFunction3(16, _c14, ctx.selected && !ctx.checkmark, ctx.disabled, ctx.focused));
