...
import {
  ...
  ScrollingModule,
  ViewportRuler
} from "./chunk-EJA465CM.js";
import {
  MatButton,
  MatButtonModule,
  MatIconButton
} from "./chunk-RJAOUBZZ.js";
import {
  DateAdapter,
  MAT_DATE_FORMATS
...
} from "./chunk-MZWB6HDG.js";
import {
  MAT_FORM_FIELD,
  MatFormFieldControl
} from "./chunk-IABMWTCR.js";
import {
  A11yModule,
  BACKSPACE,
  CdkMonitorFocus,
...
var MatDatepickerIntl = class _MatDatepickerIntl {
   ...
   */
  changes = new import_rxjs3.Subject();
...
var MatDateSelectionModel = class _MatDateSelectionModel {
  selection;
  _adapter;
  _selectionChanged = new import_rxjs3.Subject();
...
var MatMonthView = class _MatMonthView {
  ...
  _rerenderSubscription = import_rxjs3.Subscription.EMPTY;
  ...
  ngAfterContentInit() {
    this._rerenderSubscription = this._dateAdapter.localeChanges.pipe((0, import_operators3.startWith)(null)).subscribe(() => this._init());
  }
  ngOnChanges(changes) {
...
var MatDatepickerContent = class _MatDatepickerContent {
  ...
  _animationDone = new import_rxjs3.Subject();
...
var MatDatepickerBase = class _MatDatepickerBase {
  ...
  _inputStateChanges = import_rxjs3.Subscription.EMPTY;
  _document = inject(DOCUMENT);
  ...
  close() {
    ...
    if (this._componentRef) {
      ...
      instance._animationDone.pipe((0, import_operators3.take)(1)).subscribe(() => {
  ...
  _getCloseStream(overlayRef) {
    ...
    return (0, import_rxjs3.merge)(overlayRef.backdropClick(), overlayRef.detachments(), overlayRef.keydownEvents().pipe((0, import_operators3.filter)((event) => {
...
var MatDatepickerInputBase = class _MatDatepickerInputBase {
  ...
  _valueChangesSubscription = import_rxjs3.Subscription.EMPTY;
  _localeSubscription = import_rxjs3.Subscription.EMPTY;
  /**
  ...
  _matchesFilter(value) {
    const filter3 = this._getDateFilter();
    return !filter3 || filter3(value);
  }
...
var MatDatepickerInput = class _MatDatepickerInput extends MatDatepickerInputBase {
  ...
  _closedSubscription = import_rxjs3.Subscription.EMPTY;
  _openedSubscription = import_rxjs3.Subscription.EMPTY;
...
var MatDatepickerToggle = class _MatDatepickerToggle {
  _intl = inject(MatDatepickerIntl);
  _changeDetectorRef = inject(ChangeDetectorRef);
  _stateChanges = import_rxjs3.Subscription.EMPTY;
  ...
  _watchStateChanges() {
    const datepickerStateChanged = this.datepicker ? this.datepicker.stateChanges : (0, import_rxjs3.of)();
    const inputStateChanged = this.datepicker && this.datepicker.datepickerInput ? this.datepicker.datepickerInput.stateChanges : (0, import_rxjs3.of)();
    const datepickerToggled = this.datepicker ? (0, import_rxjs3.merge)(this.datepicker.openedStream, this.datepicker.closedStream) : (0, import_rxjs3.of)();
    this._stateChanges.unsubscribe();
    this._stateChanges = (0, import_rxjs3.merge)(this._intl.changes, datepickerStateChanged, inputStateChanged, datepickerToggled).subscribe(() => this._changeDetectorRef.markForCheck());
  }
...
var MatDateRangeInput = class _MatDateRangeInput {
  ...
  ngAfterContentInit() {
    ...
    (0, import_rxjs3.merge)(this._startInput.stateChanges, this._endInput.stateChanges).subscribe(() => {
      this.stateChanges.next(void 0);
    });
  }
  ngOnChanges(changes) {
